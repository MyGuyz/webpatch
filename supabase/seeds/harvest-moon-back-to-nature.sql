...
--
-- ถ้ายังไม่อยากตรวจรุ่น ให้เปลี่ยนบรรทัดนั้นเป็น null (ไม่ต้องมีเครื่องหมายคำพูด)
-- แต่ผู้ใช้ที่เอาไฟล์ผิดรุ่นมาแปะจะได้ไฟล์เสียโดยไม่รู้ตัว
--
-- ถ้าลืมแทนค่า แล้วกด Run เลย ฐานข้อมูลจะปฏิเสธพร้อมข้อความเรื่อง
-- constraint "games_source_sha1_check" — ไม่ใช่เรื่องเสียหาย แปลว่ามันกันให้
-- ไม่ให้ค่ามั่วหลุดเข้าไป แค่กลับมาแก้บรรทัดนั้นแล้ว Run ใหม่
--
-- ตรวจไฟล์แพตช์นี้แล้ว: PPF3.0 · 23,898 เรคคอร์ด · ตัวแปะของเว็บรองรับ ทดสอบผ่าน
...
insert into games (
  ...
  'ready',
  'ฉบับภาษาไทย (Thai POC) เล่นได้ครบทั้งเกม',
  'V1.0',
  'ppf',
